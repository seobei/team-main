...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#id-dup-btn").click(function() {
			...
			} else if(!idReg.test($("#useridbtn").val())){
						      		...
						      		<div class="modal-body">
						      			<form method="post" action="${appRoot }/admin/update">		  
								      		<div class="form-group">
							                    ...
							                    <input readonly value="${user.userid }" class="form-control" type="text" id="userid${userstatus.count }" name="userid" />
							                </div>
							                <div class="form-group">
		      ...
		      <div class="modal-body">
		        <form class="col-12" action="${appRoot }/admin/home" method="post">
	                <div class="form-group">
	                    ...
	                    <input class="form-control" type="text" id="useridbtn" name="userid" />
